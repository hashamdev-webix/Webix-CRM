...
export const PERMISSION_CATALOG = [
  ...
  { key: 'clients.view.all', label: 'View All Clients',       module: 'clients' },
  { key: 'clients.create',   label: 'Add / Edit Clients',     module: 'clients' },
  { key: 'clients.delete',   label: 'Delete Clients',         module: 'clients' },
  { key: 'clients.financial',label: 'View Client Financials', module: 'clients' },
];
